        ...
        <section className="text-gray-800 body-font bg-gray-100">
            <div className="container px-5 py-24 mx-auto">
                <div className="flex flex-col text-center w-full mb-20">
                    <h2 className="text-xs text-blue-500 tracking-widest font-medium title-font mb-1">PT-DO-MTMO</h2>
                    <h1 className="sm:text-3xl text-2xl font-medium title-font mb-4 text-gray-900">Formación Académica</h1>
                    <p className="lg:w-2/3 mx-auto leading-relaxed text-base">Perfeccionamiento continuo al servicio de tu recuperación.</p>
                </div>
                <div className="flex flex-wrap">
                    <div className="w-full xl:w-1/4 lg:w-1/2 md:w-full px-8 py-6 bg-white border-l-2 border-gray-200 border-opacity-60">
                    ...
                    <div className="w-full xl:w-1/4 lg:w-1/2 md:w-full px-8 py-6 bg-white border-l-2 border-gray-200 border-opacity-60">
                        ...
                        <p className="leading-relaxed text-base mb-4">Manual therapy, upper and lower quadrant.</p>
                    </div>
                    <div className="w-full xl:w-1/4 lg:w-1/2 md:w-full px-8 py-6 bg-white border-l-2 border-gray-200 border-opacity-60">
